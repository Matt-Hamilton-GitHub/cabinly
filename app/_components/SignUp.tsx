...
import { Mail, Lock, User, ArrowRight, Mountain, CheckCircle2 } from 'lucide-react'
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#0f3d3e] flex-col
          ...
          <div className="absolute top-1/3 right-10 w-32 h-32 opacity-[0.04]">
            <svg viewBox="0 0 100 100">
              <polygon points="50,5 95,75 5,75"
                stroke="#e8f0ed" strokeWidth="1" fill="none" />
            </svg>
          </div>
        </div>
          ...
          <div className="space-y-3">
            {perks.map((perk) => (
              <div key={perk} className="flex items-center gap-3">
                <CheckCircle2 size={15} className="text-[#a8d5d0] flex-shrink-0" />
        ...
        <div className="relative border-t border-[#e8f0ed]/10 pt-6">
          <p className="text-xs text-[#e8f0ed]/30 font-light">
            Already trusted by 2,400+ travellers across 6 continents.
