    ...
    return (
        <div className="flex items-center gap-10 p-6 justify-between bg-[black] text-[white] ">
            ...
            <div className="flex flex-row gap-2 border-[black] border-2 bg-[white] p-2 rounded-xl shadow-lg inset-shadow-gray-550 text-[black] hover:scale-110 hover:text-[white]  hover:border-[white] transition-all ease-in-out hover:bg-[black]">
                {user ? <Link href='/account'> <div className="flex flex-row gap-2 items-center justify-center"><CircleUserRound /><span className="hidden md:block">Account</span></div> </Link>: <Link href='/log-in'>Log in</Link> }
            </div>
        </div>)
}
