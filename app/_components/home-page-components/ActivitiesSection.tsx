const ActivitiesSection = () => {
  return (
    <section id="activities" className="py-24 hero-gradient-40-deg">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16 ">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Every activity is led by certified local professionals who share
              ...
              >
                <div className="w-14 h-14 rounded-xl bg-cyan-500/20 flex items-center justify-center mb-4">
                  <svg
                    ...
                    strokeWidth="2"
                  >
                    <path d="M12 2L8 8H4L8 14L4 22H12L16 14L20 22H20L16 8H20L12 2Z" />
                  </svg>
                </div>
                <h3 className="text-xl font-semibold mb-2">Skiing</h3>
                <p className="text-gray-400 text-sm mb-4">
                  From beginner slopes to expert backcountry runs
                </p>
                <div className="flex items-center justify-between text-sm">
                  <span className="text-cyan-400">All levels</span>{" "}
