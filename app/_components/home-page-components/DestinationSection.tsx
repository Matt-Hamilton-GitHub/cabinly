  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-6">
     <div className="text-center mb-16 "><span className="text-orange-500 text-sm tracking-widest uppercase">Explore</span>
      <h2 className="font-serif text-4xl md:text-5xl font-bold mt-2 mb-4 text-[#0f3d3e]">Breathtaking Destinations</h2>
      <p className="text-gray-400 max-w-2xl mx-auto font-light">From snow-capped peaks to serene valleys, choose your perfect escape</p>
     </div>
