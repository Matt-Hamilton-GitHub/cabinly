...
import { PlaceType, CabinType, ActivityType, AvailableDateType } from '@/app/places/page'
...
const PriceSummary = ({
  ...
  const cabinSubtotal = selectedCabin
    ? selectedCabin.pricePerNight * selectedDate.nights
    : 0
  ...
  return (
    <div className="bg-[#0f3d3e] rounded-2xl p-6 space-y-4">
      ...
      <button className="w-full py-3 rounded-full bg-[#a8d5d0] text-[#0f3d3e]
